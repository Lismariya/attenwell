  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'pulse-deep': 'pulse-deep 1.5s cubic-bezier(0.4, 0, 0.6, 1) infinite',
        'explode': 'explode 0.5s ease-out forwards',
        'pop-up-and-down': 'pop-up-and-down 1.5s ease-in-out forwards',
        'pulse-scale': 'pulse-scale 2s cubic-bezier(0.4, 0, 0.6, 1) infinite',
        'spin-slow': 'spin-slow 8s linear infinite',
        'blink': 'blink 1s cubic-bezier(0.4, 0, 0.6, 1) 2',
        'pulse-zoom': 'pulse-zoom 5s ease-in-out infinite',
      },
    },
  },
